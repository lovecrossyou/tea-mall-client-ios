...
- (void)setupUI {
    ...
    [self.recorderButton mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.size.mas_equalTo(self.recorderButton.bounds.size);
    }];
    ...
    [self.stickerButton mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.size.mas_equalTo(self.stickerButton.bounds.size);
    }];
    ...
    [self.nextButton mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.size.mas_equalTo(self.nextButton.bounds.size);
    }];
    ...
    [self.musicButton mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.size.mas_equalTo(CGSizeMake(38, 70));
    ...
    [backButton mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.size.mas_equalTo(backButton.bounds.size);
    }];
}
